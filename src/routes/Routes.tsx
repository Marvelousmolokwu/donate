...
export const Routes = () => {
    const router = createBrowserRouter(
        createRoutesFromElements(
          ...
          <Route path={"/:user/form1"} element={<React.Suspense fallback={<Loader/>}><LazyForm1 /></React.Suspense>}/>
          <Route path={"/:user/form2"} element={<React.Suspense fallback={<Loader/>}><LazyForm2/></React.Suspense>}/>
