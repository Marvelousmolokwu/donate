...
const navigate = useNavigate()
  ...
  return (
    ...
    <div className={`  bg-backgroundcolor w-[85%] md:w-[50%] lg:w-[40%]  rounded-md shadow-sm p-10  z-50 fc-flex gap-5
    `}>
        <h1>hey User</h1>
        <p>Complete your KYC by clicking the button</p>
        <div className="fc-flex gap-5 lg:fr-flex">
            <Button content="Complete your KYC" btnClasses="text-backgroundcolor bg-primary w-full " handleClick={()=>{
