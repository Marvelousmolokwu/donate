...
<div className=""><ul >
            ...
            <div>
            <ul >
                <li><h3>Let's Connect</h3></li>
                <li ><a href="">X</a></li>
                <li><a href="">Instagram</a></li>
                <li><a href="">Facebook</a></li>
                <li><a href="">Linkedin</a></li>
                <li><a href="">donatelink@gmail.com</a></li>
            </ul>
           
        </div>
        <Button handleClick={handleClick} content="Sign up Now" btnClasses="bg-primary text-backgroundcolor w-[50%] lg:w-auto"/>
</section>
<p className="text-center">© Copyright 2023 - DonorLink. All rights reserved.</p>
</footer>
  )
}
